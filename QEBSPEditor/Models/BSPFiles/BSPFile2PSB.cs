...
public class BSPFile2PSB : BSPFileBase, IBSPFile, IBSPFileEntities, IBSPFileLighting, IBSPSave
{
    /* 
    ...
    */
    ...
    public string VersionName => "2PSB";
    ...
    private static void ReadEntityChunk(ChunkHeader header, BSPFile2PSB file, BinaryReader reader)
    {
    ...
    private static void ReadFaceChunk(ChunkHeader header, BSPFile2PSB file, BinaryReader reader)
    {
        reader.BaseStream.Seek(header.Offset, SeekOrigin.Begin);
